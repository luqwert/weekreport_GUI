...
def cnfeol(username,password,cookies):
    ...
    gl.set_value('menggkuang_kucun', menggkuang_kucun)
    gl.set_value('updown_mengkuang', updown_mengkuang)
    gl.set_value('diff_mengkuang', diff_mengkuang)
    # print(stock)
    print(stock2)
    print(diff_mengkuang)
